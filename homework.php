        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="scoreboard-result">
                    ...
                    <div class="your-account"><div class="icon icon-your-account"></div> ваш счет:</div>
                    <div class="amount">2500 рублей</div>
...
<section class="available-video">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="personal-name">Здравствуйте Владимир!</div>
            </div>
            <div class="col-xs-12">
                <div class="box-video">
            ...
            <div class="box-task">
                ...
                <ul class="nav nav-pills" role="tablist">
                    <li role="presentation" class="active">
                        <a href="#task-1" aria-controls="home" role="tab" data-toggle="tab">
                            <span class="number">1</span>
                            <span class="title">задание</span>
                        </a>
                    </li>
                    <li role="presentation">
                        <a href="#task-2" aria-controls="home" role="tab" data-toggle="tab">
                            <span class="number">2</span>
                            <span class="title">задание</span>
                        </a>
                    </li>
                    <li role="presentation">
                        <a href="#task-3" aria-controls="home" role="tab" data-toggle="tab">
                            <span class="number">3</span>
                            <span class="title">задание</span>
                        </a>
                    </li>
                    <li role="presentation">
                        <a href="#task-4" aria-controls="home" role="tab" data-toggle="tab">
                            <span class="number">4</span>
                            <span class="title">задание</span>
                        </a>
                    </li>
                    <li role="presentation">
                        <a href="#task-5" aria-controls="home" role="tab" data-toggle="tab">
                            <span class="number">5</span>
                            <span class="title">задание</span>
                        </a>
                    </li>
                    <li role="presentation">
                        <a href="#task-6" aria-controls="home" role="tab" data-toggle="tab">
